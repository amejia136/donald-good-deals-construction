        ...
        <div className="contact-page">
          ...
          <span className="ci-icon">
            {/* Phone circle */}
              ...
              <path d="M15.5 16.5c-2.9-1-5.1-3.2-6.1-6.1l2.1-2.1c.2-.2.2-.6 0-.9L9.1 5.1c-.2-.2-.6-.2-.9 0L6.4 6.8c-.3.3-.5.8-.4 1.2c.9 4 4 7.1 7.9 8c.5.1 1-.1 1.3-.4l1.7-1.8c.2-.2.2-.6 0-.8l-2.3-2.3c-.2-.2-.6-.2-.8 0l-2 2z" fill="#F5D014"/>
            </svg>
          </span>
                    <a className="ci-text" href="tel:6311234567">631.123.4567</a>
                </div>
          ...
          <span className="ci-icon">
            {/* Envelope */}
              ...
              <path d="M4 7l8 6l8-6" fill="none" stroke="#F5D014" strokeWidth="2" strokeLinecap="round"/>
                    ...
                    <a className="ci-text" href="mailto:info@example.com">info@example.com</a>
                </div>
